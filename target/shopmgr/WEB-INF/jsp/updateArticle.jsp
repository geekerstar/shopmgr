...
<nav class="navbar navbar-fixed-top navbar-inverse" role="navigation">
    <div class="container">
        <div class="navbar-header">
            <a class="navbar-brand" href="<c:url value="/list?method=getAll"/>">电商卖家系统-商品管理</a>
        </div>
    ...
    <div class="row row-offcanvas row-offcanvas-right">
        <fieldset style="width:700px;">
            ...
            <form name="articleform" class="form-horizontal"
                  action="${pageContext.request.contextPath}/list?method=updateArticle"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input type=text class="form-control" value="${article.putawayDate}" name="putawayDate"
                ...
                <table align="center">
                    <tr>
                        ...
                        <td>&nbsp;&nbsp;<input type="button" onclick="window.location = 'list?method=getAll' ; "
